export const description = {
    html: 'HTML is one of those elements in web development that I got acquainted with during ' +
    ...
    css: 'I have a good grasp of the core principles of CSS, such as selector usage, styling ' +
    ...
    javaScript: 'I\'ve been studying JavaScript for over a year now and during this time, " +\n' +
    ...
    typescript: 'In modern development, it\'s hard to imagine working without TypeScript. ' +
    ...
    react: "React was the first framework I got acquainted with, and I really enjoyed ' +\n" +
    ...
    redux: 'In my projects, I decided to use the Redux state manager. I already have experience ' +
    ...
    styleComponent: 'When creating my educational projects, I initially used CSS modules. However, ' +
    ...
    materialUI: 'I enjoy creating styles on my own, but I acknowledge that the Material-UI (MUI)' +
                'library is extremely useful. I often turn to using it and aim to fully master the ' +
                'skills of creating components using MUI.',
    storybook: "I\\'m very pleased to have had the opportunity to get acquainted with Storybook. ' +\n" +
    ...
    jest:       'I actively use Jest in my development process. This tool helps me create reliable' +
    ...
    figma: 'I actively use Figma for layout based on design mockups.',
    git: 'Git is another important tool I use in my development process. I\'m familiar ' +
