    ...
    return (
        <StyledSkills>
            ...
            <FlexContainer wrap={'wrap'} justify={'space-around'} aline={'centre'} >
                ...
                <Skill level={6}  iconId={'html'} skillTitle={'HTML'}
                ...
                <Skill level={6} iconId={'css'} skillTitle={'CSS'}
                ...
                <Skill level={7} iconId={'js'} skillTitle={'JavaScript'}
                ...
                <Skill level={5} iconId={'ts'} skillTitle={'TypeScript'}
                       description={'In modern development, it\'s hard to imagine working without TypeScript. ' +
                           ...
                           <Skill level={6} iconId={'react'} skillTitle={'React'}
                           ...
                           <Skill level={6} iconId={'redux'} skillTitle={'Redux'}
                           ...
                           description={'When creating my educational projects, I initially used CSS modules. However, ' +
                            ...
                            <Skill level={4} iconId={'mui'} skillTitle={'Material UI'}
                       description={'I enjoy creating styles on my own, but I acknowledge that the Material-UI (MUI)' +
                           ...
                           <Skill level={4} iconId={'storybook'} skillTitle={'Storybook'}
                           ...
                           <Skill level={3} iconId={'jest'} skillTitle={'Jest'}
                           ...
                           <Skill level={2} iconId={'gitTeh'} skillTitle={'GitHub'}
